...
| Message                         | Who sends it?   | What does it ask/tell?                                    | Main purpose                           |
| ------------------------------- | --------------- | --------------------------------------------------------- | -------------------------------------- |
| **NS** – Neighbor Solicitation  | Host → Neighbor | **"What is your MAC address?"**                           | Find a neighbor's MAC address          |
| **NA** – Neighbor Advertisement | Neighbor → Host | **"This is my MAC address."**                             | Reply to NS / announce its MAC         |
...
| Purpose                           | IPv4                                                | IPv6           |
| --------------------------------- | --------------------------------------------------- | -------------- |
| **Find device's MAC**             | **ARP**                                             | **NS/NA**      |
| **Find router / get router info** | **DHCP / configured gateway + ARP for gateway MAC** | **RS/RA**      |
| **Get network configuration**     | **DHCP**                                            | **RA (SLAAC)** |
